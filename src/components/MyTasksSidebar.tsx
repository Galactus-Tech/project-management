                        ...
                        {myTasks.length === 0 ? (
                            ...
                            myTasks.map((task) => (
                                <Link
                                    ...
                                    className="w-full rounded-lg transition-all duration-200 text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white block"
                                >
                                    <div className="flex items-center gap-2 px-3 py-2 w-full min-0">
