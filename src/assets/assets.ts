                ...
                "tasks": [
                    ...
                    },
                    {
                        ...
                        "comments": [
                            {
                                "id": "c_1",
                                "content": "Reproduced the issue when importing CSV files with UTF-8 encoding.",
                                "userId": "user_2",
                                "taskId": "782f0f4a-89a1-4328-9538-4e8979fc61a3",
                                "createdAt": "2025-10-14T09:30:00.000Z",
                                "user": dummyUsers[1]
                            }
                        ],
                        "subtasks": [
                            { "id": "st_1", "title": "Audit CSV deduplication regex", "completed": true },
                            { "id": "st_2", "title": "Add unit test for email case sensitivity", "completed": true },
                            { "id": "st_3", "title": "Deploy patch to staging", "completed": false }
                        ],
                        "attachments": [
                            {
                                "id": "att_1",
                                "name": "import_error_log.txt",
                                "size": 14200,
                                "type": "text/plain",
                                "uploadedAt": "2025-10-14T09:35:00.000Z"
                            }
                        ]
                    },
                    {
                        ...
                        "comments": [
                            {
                                "id": "c_2",
                                "content": "Designing permission schema and route guards.",
                                "userId": "user_1",
                                "taskId": "7989b4cc-1234-4816-a1d9-cc86cd09596a",
                                "createdAt": "2025-10-15T11:20:00.000Z",
                                "user": dummyUsers[0]
                            }
                        ],
                        "subtasks": [
                            { "id": "st_4", "title": "Define UserRoles enum and permission matrix", "completed": true },
                            { "id": "st_5", "title": "Protect admin API routes", "completed": false },
                            { "id": "st_6", "title": "Update UI navigation visibility based on role", "completed": false }
                        ],
                        "attachments": [
                            {
                                "id": "att_2",
                                "name": "rbac_architecture.pdf",
                                "size": 245000,
                                "type": "application/pdf",
                                "uploadedAt": "2025-10-15T11:25:00.000Z"
                            }
                        ]
                    }
                ],
